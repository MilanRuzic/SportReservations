...
{
    public class GetForDropdownQueryHandler<TViewModel, TQuery, TEntity>
        : IRequestHandler<TQuery, IList<TViewModel>>
        ...
        where TEntity : class
    {
        ...
        public virtual async Task<IList<TViewModel>> Handle(
            TQuery request,
