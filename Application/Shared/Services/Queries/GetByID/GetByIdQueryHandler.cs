...
{
    public class GetByIdQueryHandler<TViewModel, TQuery, TEntity>
        : IRequestHandler<TQuery, ServiceResult<TViewModel>>
        ...
        where TEntity : class
    {
        ...
        public virtual async Task<ServiceResult<TViewModel>> Handle(
            TQuery request,
        ...
        )
        {
            ...
            return new ServiceResult<TViewModel> { IsError = false, Result = result };
        }
    }
}
